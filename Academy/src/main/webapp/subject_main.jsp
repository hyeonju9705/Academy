		...
		<div class="col-lg-8 bg-box3">
			<div class="col-lg-2 leftbarBox">
				<div class="container">
					...
					<form name="input" action="getfeedback.html" method="get">
						...
						<ul class="select">
							<li id="menu_notice" onclick="location.href='viewProc.do?userId=<%=request.getParameter("userId")%>'">공지사항</li>
						</ul>
						<ul class="select">
			...
			<div class="col-lg-7 nameBigbox">
				...
				<div class="subject_namebox">
					...
					<ul>
						<li class="notice_li">나를 찾는 스타트업 활동법 연재기사 읽기</li>
						<li class="notice_li">런치패드 반납안내</li>
						<li class="notice_li">보강안내</li>
						<li class="notice_li">11월 24일,25일 휴강 공지</li>
						<li class="notice_li">기말고사 공지</li>
						<p class="moreview">
							<a href="#">더보기 >></a>
						</p>
					</ul>
